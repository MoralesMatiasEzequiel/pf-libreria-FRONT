...
export const { pushProductOnCart, removeProductFromCart, postOrderCreated, setClientInfo, setShipmentInfo, newCartState, sendOrderToBack, cleanPaymentLinkState, totalPrice } = cartSlice.actions
